                ...
                <div class="col-md-11">
                    <div class="panel panel-default">
                        <div style="float: right; padding-top: 10px; padding-right:10px">
                            <a href="{{route('customer.index')}}" type="submit" class="panel-title btn btn-purple waves-effect waves-light"> <i class="fa-solid fa-backward-step"></i> Back
                            </a>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" class="form-control"
                                                   id="exampleInputEmail1" value="{{$customer->email}}"
                                    ...
                                    <div class="col-6 col-md-4">
                                        ...
                                        <div class="flex items-center justify-center">
                                            <img id="image" src="{{\Illuminate\Support\Facades\Storage::url($customer->photo)}}"
